...
nnoremap <C-w>  <C-u>
nnoremap <C-u>  <Nop>
" you can add this config but i dont think its needed: set showcmd - typed commands; set t_Co=256 - tell vim that the terminal has 256 colors; set autoread - read when file is changed. 
